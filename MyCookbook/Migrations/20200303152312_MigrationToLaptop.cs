...
{
    public partial class MigrationToLaptop : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Make pasta Carbonara...", "Pasta Carbonara" },
                    { 2, "Make pancakes...", "Pancakes" },
                    { 3, "Make salad...", "Salad" },
                    { 4, "Make pumkinsoup...", "Pumkinsoup" },
                    { 5, "Make pizza...", "Pizza" }
                });

            migrationBuilder.InsertData(
                table: "RecipeItems",
                columns: new[] { "RecipeId", "IngredientId", "Name", "Quantity", "Unit" },
                values: new object[,]
                {
                    { 1, 1, "Cheese", 100, "Grams" },
                    { 1, 2, "Milk", 500, "Mililiter" },
                    { 2, 3, "Pumpkin", 1, "Piece" },
                    { 2, 4, "Sugar", 20, "Grams" },
                    { 2, 5, "Beans", 150, "Grams" }
                });
